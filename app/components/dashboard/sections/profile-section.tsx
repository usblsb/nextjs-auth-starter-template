...
export default function ProfileSection({ user, onError, onLoading, className = '' }: ProfileSectionProps) {
  ...
  const profileData = {
    ...
    email: user?.primaryEmailAddress?.emailAddress || user?.emailAddresses?.[0]?.emailAddress || 'No disponible',
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800">
              ...
              Para modificar tu nombre o email, utiliza las opciones de configuración de seguridad.
            </p>
          </div>
        </div>
      </div>
